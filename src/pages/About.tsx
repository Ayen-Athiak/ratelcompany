  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      {[
        ...
        <div
          key={name}
          className="group bg-white border border-gray-100 rounded-xl overflow-hidden hover:border-gold/30 hover:shadow-lg transition-all duration-300 flex flex-col"
        >
          {/* Photo */}
          <div className="w-full flex-shrink-0 overflow-hidden bg-gray-50">
            <img
              src={image}
              alt={name}
