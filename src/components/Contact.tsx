...
export default function Contact() {
  ...
  const submit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    const { error: err } = await supabase.from('quotes').insert([payload])
    setLoading(false)
    if (err) {
  ...
  return (
    <>
      {/* HERO */}
      <section
        className="relative pt-32 pb-20 min-h-[48vh] flex items-end overflow-hidden"
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 flex flex-col gap-5">
            <div>
              ...
              <h2 className="text-2xl font-serif font-bold text-navy mb-3">Let's Talk</h2>
